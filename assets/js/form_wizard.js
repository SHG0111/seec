...
(function($) {
    ...
    $(document).ready(function() {
        ...
        // $(".js-nav-tabs li a[href*="+location.pathname.split("/")[3].split(".html")[0]+"]").addClass("active").closest('.js-nav-tabs').find('.active.show').removeClass('active')
        $(".js-nav-tabs li a[href*="+location.pathname.split("/")[2].split(".html")[0]+"]").addClass("active").closest('.js-nav-tabs').find('.active.show').removeClass('active')
    });
